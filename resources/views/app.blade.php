...
<head>
    ...
    <title>Hadq - حــدق</title>
    <link href="{{ asset('img/logo.png') }}" rel="icon">

    <meta property="og:site_name" content="Hadq - حــدق">
    <meta property="og:title" content="  عـيـنٌ أمـعـنـت  فـأبـدعـــت " />
    <meta property="og:description" content="{{ $data['royaa_desc_Ar'] }}" />
    <meta property="og:image" itemprop="image" content="{{ asset('img/logo.png') }}">
    <meta name="keywords"
        content="تصميم هويات تجارية , حدق , السعودية , تصميم , تصميم لوجو , هوية تجارية , لوجو , السعودية ">
